            ...
            let data1 = {
                options: [
                    ...
                    },
                    {
                        ...
                        title: 'ខ្មែរ',
                        text: 'Cambodia',
                        //img: 'https://pluginus.net/wp-content/uploads/2021/03/cambodia.gif'
                        img:'flags/km.png'
                    },
                    {
                        value: 'euros',
...
delete data2.max_open_height;
            ...
            var selector3 = new Selectron23(document.querySelector('#lang'), {});
...
*/
            selector3.onSelect = function () {
                ...
                var oldVal = document.getElementById("lang").value;
                //alert("Old lang : " + oldVal + " New Value: " + this.value);
                //Declared In Header modules
                //alert("User Id:" + document.getElementById("id_user").value + " id_lang: " + this.value);
