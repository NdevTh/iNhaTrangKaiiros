...
class myOpeningHours extends ObjectModel
{
    protected static $table      = 'opening_hour';
    protected static $identifier = 'id_opening_hour';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_opening_hour','id_company','code','day','hours','date_add','date_upd');
    protected static $fieldsSize       = array('id_opening_hour' => 10, 'id_company' =>10, 'code' => 10,  'day' => 155, 'hours' => 255);
    protected static $fieldsValidation = array('id_opening_hour' => 'isUnsignedIntAuto', 'id_company' =>'isUnsignedTinyIntDefault0', 'code' => 'isVarCharDefaultNull', 'day' => 'isVarCharDefaultNull','hours' => 'isVarCharDefaultNull','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_opening_hour');
