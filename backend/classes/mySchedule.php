...
class mySchedule extends ObjectModel
{
    protected static $table      = 'schedule';
    protected static $identifier = 'id_schedule';
    ...
    protected static $fieldsRequired   = array('id_schedule','id_task_group','planning_date','code','equipment','description','active','deleted','date_add','date_upd','sync');
    protected static $fieldsSize       = array('id_schedule' => 10,'id_task_group' => 10,'code' => 10,'equipment' => 10,,'description'=>255,'sync'=>1);
    protected static $fieldsValidation = array('id_schedule' => 'isUnsignedIntAuto', 'id_task_group' => 'isUnsignedInt','planning_date'=>'isDate', 'code'=>'isVarCharDefaultNull', 'equipment'=>'isVarCharDefaultNull','description'=>'isVarCharDefaultNull','active'=>'isUnsignedTinyIntDefault0','deleted'=>'isUnsignedTinyIntDefault0','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull','sync'=>'isUnsignedTinyintDefault0');
    protected static $keysValidation   = array('Primary Key' =>'id_schedule');
