...
class myAbout extends ObjectModel
{
    protected static $table      = 'about';
    protected static $identifier = 'id_about';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_about','id_lang','code','title','description','date_add','date_upd');
    protected static $fieldsSize       = array('id_about' => 10,'id_lang' => 10,  'code' => 10,  'title' => 155, 'description' => 255);
    protected static $fieldsValidation = array('id_about' => 'isUnsignedIntAuto', 'id_lang' =>'isUnsignedTinyIntDefault0', 'code' => 'isVarCharDefaultNull', 'title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_about');
