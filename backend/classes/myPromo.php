...
class myPromo extends ObjectModel
{
    protected static $table      = 'promo';
    protected static $identifier = 'id_promo';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_promo','id_lang','id_bom','code','title','description', 'img_name','active','date_add','date_upd');
    protected static $fieldsSize       = array('id_promo' => 10, 'id_lang' =>10,'id_bom' =>10,'code' => 10,'title' => 200, 'description' => 255, 'img_name' => 255,'active'=>3);
    protected static $fieldsValidation = array('id_promo' => 'isUnsignedIntAuto', 'id_lang' =>'isUnsignedTinyIntDefault0', 'id_bom' =>'isUnsignedTinyIntDefault0', 'code' => 'isVarCharDefaultNull','title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull', 'img_name' => 'isVarCharDefaultNull','active'=>'isUnsignedTinyIntDefault0','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_promo');
