...
class myAccount extends ObjectModel
{
    protected static $table      = 'account';
    protected static $identifier = 'id_account';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_account','code','account_title','description','status','date_start','date_end','date_add','date_upd');
    protected static $fieldsSize       = array('id_account' => 10, 'code' => 10,  'account_title' => 255, 'description' => 255, 'status' =>3);
    protected static $fieldsValidation = array('id_account' => 'isUnsignedIntAuto', 'code' => 'isVarCharDefaultNull', 'account_title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','status' => 'isUnsignedTinyintDefault0','date_start'=>'isDate','date_end'=>'isDate','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_account');
