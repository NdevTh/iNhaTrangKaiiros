...
class myPaymentMode extends ObjectModel
{
    protected static $table      = 'payment_mode';
    protected static $identifier = 'id_payment_mode';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_payment_mode','id_lang','code','title','description','active','date_add','date_upd');
    protected static $fieldsSize       = array('id_payment_mode' => 10,'id_lang' =>10, 'code' => 10,  'title' => 155, 'description' => 255,'active'=>3);
    protected static $fieldsValidation = array('id_payment_mode' => 'isUnsignedIntAuto', 'id_lang' =>'isUnsignedTinyIntDefault0','code' => 'isVarCharDefaultNull', 'title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','active'=>'isUnsignedTinyIntDefault0','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_payment_mode');
