...
class myJob extends ObjectModel
{
    protected static $table      = 'job';
    protected static $identifier = 'id_job';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_job','code','title','description','date_add','date_upd');
    protected static $fieldsSize       = array('id_job' => 10, 'code' => 10,  'title' => 155, 'description' => 255);
    protected static $fieldsValidation = array('id_job' => 'isUnsignedIntAuto', 'code' => 'isVarCharDefaultNull', 'title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_job');
