...
class myWorkOrderStatus extends ObjectModel
{
    protected static $table      = 'work_order_status';
    protected static $identifier = 'id_work_order_status';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_work_order_status','code','status','description','date_add','date_upd');
    protected static $fieldsSize       = array('id_work_order_status' => 10, 'code' => 10,  'status' => 155, 'description' => 255);
    protected static $fieldsValidation = array('id_work_order_status' => 'isUnsignedIntAuto', 'code' => 'isVarCharDefaultNull', 'status' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_work_order_status');
