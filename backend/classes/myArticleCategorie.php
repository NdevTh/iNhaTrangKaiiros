...
class myArticleCategorie extends ObjectModel
{
    protected static $table      = 'article_categorie';
    protected static $identifier = 'id_article_categorie';
    public static $prefix        = 'rtt_';
    
    protected static $fieldsDefinition = array('class_name','position');
    protected static $fieldsRequired   = array('id_article_categorie','id_lang','code','title','description','active','date_add','date_upd');
    protected static $fieldsSize       = array('id_article_categorie' => 10, 'id_lang' => 10,'code' => 10,  'title' => 155, 'description' => 255,'active'=>3);
    protected static $fieldsValidation = array('id_article_categorie' => 'isUnsignedIntAuto', 'id_lang'=>'isUnsignedTinyIntDefault0','code' => 'isVarCharDefaultNull', 'title' => 'isVarCharDefaultNull','description' => 'isVarCharDefaultNull','active'=>'isUnsignedTinyIntDefault0','date_add'=>'isDateTimeNotNull','date_upd'=>'isDateTimeNotNull');
    protected static $keysValidation   = array('Primary Key' =>'id_article_categorie');
